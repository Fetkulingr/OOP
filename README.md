...
Таким образом, мы создали игру "Камень, ножницы, бумага" на Python и использовали паттерны Singleton и Factory для достижения гибкости и управления процессами создания игры в нашей программе.
