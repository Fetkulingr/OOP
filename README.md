...
Таким образом, создана игра "Камень, ножницы, бумага" на Python и использованы паттерны Singleton и Factory для достижения гибкости и управления процессами создания игры в нашей программе.
